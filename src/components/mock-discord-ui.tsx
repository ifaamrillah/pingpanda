...
export const MockDiscordUI = ({ children, ...props }: PropsWithChildren) => {
  return (
        ...
        <div className="flex-1 overflow-y-auto pt-4">
          <div className="px-2 mb-4">
            <div className="flex items-center text-sm px-2 py-1.5 rounded hover:bg-[#393C43] text-[#DCDDDE] cursor-not-allowed">
              <UserCircle className="mr-4 size-6 text-[#B6BBBE]" />
              <span className="font-medium text-sm">Friends</span>
            </div>
            <div className="flex items-center text-sm px-2 py-1.5 rounded hover:bg-[#393C43] text-[#DCDDDE] cursor-not-allowed">
              <Inbox className="mr-4 size-6 text-[#B6BBBE]" />
        ...
        <div className="p-4">
          <div className="flex items-center bg-[#40444B] rounded-lg p-1">
            ...
            <input
              readOnly
              type="text"
              placeholder="Message @PindPanda"
              className="flex-1 bg-transparent py-2.5 px-1 text-white placeholder:text-[#72767D] focus:outline-none cursor-context-menu"
            />
