...
import { MockDiscordMessageUI } from "@/components/mock-discord-message-ui"
...
export default function LandingPage() {
  ...
  return (
    <>
              ...
              <MockDiscordUI>
                <AnimatedList>
                  ...
                  <MockDiscordMessageUI
                    ...
                    content={{
                      amount: "$49.00",
                      email: "zoe.martines2001@gmail.com",
                      plan: "PRO",
                    }}
                  />
                  <MockDiscordMessageUI
      ...
      {/* Bento Grid */}
      <section className="relative py-24 sm:py-32 bg-brand-25">
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:ga-20">
          <div>
          ...
          <div className="grid gap-4 lg:grid-cols-3 lg:grid-rows-2">
            ...
            <div className="relative mx-lg:row-start-3 lg:col-start-2 lg:row-start-2">
              ...
              <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)]">
                ...
                <div className="flex flex-1 items-center justify-center px-8 max-lg:pb-12 max-lg:pt-10 sm:px-10 lg:pb-2s">
                  <Image
        ...
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-20">
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 divide-y lg:divide-y-0 lg:divide-x divide-gray-200">
            ...
            <div className="flex flex-auto flex-col gap-4 bg-brand-25 p-6 sm:p-8 lg:p-16 rounded-t-[2rem] lg:rounded-tr-none lg:rounded-l-[2rem]">
              ...
              <p className="text-base sm:text-lg lg:text-lg/8 font-medium tracking-tight text-brand-900 text-center lg:text-left text-pretty">
            ...
            <div className="flex flex-auto flex-col gap-4 bg-brand-25 p-6 sm:p-8 lg:p-16 rounded-b-[2rem] lg:rounded-bl-none lg:rounded-r-[2rem]">
              ...
              <p className="text-base sm:text-lg lg:text-lg/8 font-medium tracking-tight text-brand-900 text-center lg:text-left text-pretty">
                PingPanda's been paying off our SaaS. Nice to have simple way to
          ...
          <ShinyButton
            href="/sign-up"
            className="relative z-10 h-10 w-fll max-w-xs text-base shadow-lg transition-shadow duration-300 hover:shadow-xl"
          >
            Start For Free Today
          </ShinyButton>
        </MaxWidthWrapper>
